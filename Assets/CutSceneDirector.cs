...
public class CutSceneDirector : MonoBehaviour
{
    ...
    private IEnumerator CutScen()
    {
        ...
        pgbg.GetComponent<RectTransform>().localPosition = new Vector3(pgbg.GetComponent<RectTransform>().localPosition.x, pgbg.GetComponent<RectTransform>().localPosition.y, 5);
        ...
        yield return new WaitForSeconds(0.1f);
        isdn = false;
        pg1.GetComponent<RectTransform>().localPosition = new Vector3(pg1.GetComponent<RectTransform>().localPosition.x, pg1.GetComponent<RectTransform>().localPosition.y, pg2.GetComponent<RectTransform>().localPosition.z+0.8f);
        ...
        yield return new WaitForSeconds(0.1f);
        isdn2 = false;
        pg2.GetComponent<RectTransform>().localPosition = new Vector3(pg2.GetComponent<RectTransform>().localPosition.x, pg2.GetComponent<RectTransform>().localPosition.y,4);
        ...
        yield return new WaitForSeconds(0.1f);
        isdn2 = false;
        pg4.GetComponent<RectTransform>().localPosition = new Vector3(pg4.GetComponent<RectTransform>().localPosition.x, pg4.GetComponent<RectTransform>().localPosition.y, 1);
